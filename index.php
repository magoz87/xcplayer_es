...
<html lang="en">
   ...
   <body onselectstart="return false" oncontextmenu="return false" ondragstart="return false">
      ...
      <div id="login" class="container-fluid standard-bg">
         ...
         <div class="row header-top">
            ...
            <div class="col-lg-3 col-md-6 col-sm-12">
               ...
               <?php if(ATIVAR_TESTE == 1) { ?>
                  <button type="button" class="access-btn" data-toggle="modal" data-target="#enquirypopup">Demo Gratis Ahora</button>
                  <?php } ?>
               </div>
            </div>
         </div>
        ...
        <div class="alert alert-danger"><b>OCURRIO UN ERROR</b> Lo sentimos, ya solicitaste una prueba en nuestro sistema.</div>                         
        <?php } ?>
        <?php if($_GET['sess'] == 'block') { ?>
        <div class="alert alert-danger"><b>USUARIO BLOQUEADO</b> Lo sentimos, su usuario está bloqueado o caducó, póngase en contacto con el proveedor.</div> 
        <?php } ?>
        <?php if($_GET['sess'] == 'erro') { ?>
        <div class="alert alert-danger"><b>DATOS INVÁLIDOS</b> Lo sentimos, no se pudo iniciar sesión, no se encontraron datos en el sistema.</div> 
        <?php } ?>      
